    ...
    <div id="AddUrl" v-if="isOff">
        <div class="loading">
            ...
            <div class="uploadContent">
                <input type="text" class="uploadName" placeholder="输入网站名称" v-model="enterName">
                <input type="url" class="uploadHttps" placeholder="输入网址" v-model="enterHttps">
                <button @click="addCotents" class="btn">添加</button>
